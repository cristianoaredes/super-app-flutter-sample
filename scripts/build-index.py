#!/usr/bin/env python3
"""Compatibility shim (TCK-1057 / DES-0195) — implementation: scripts/state/build-index.py

Keep `python3 scripts/build-index.py` working. Prefer domain path for new call sites.
...
_TARGET = Path(__file__).resolve().parent / "state" / "build-index.py"
...
def _load_impl():
    name = 'codebase_ops_shim_build_index'
