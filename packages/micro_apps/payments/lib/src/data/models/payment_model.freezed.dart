...
class _$PaymentModelImpl implements _PaymentModel {
  ...
  @override
  String toString() {
    return 'PaymentModel(id: $id, amount: $amount, recipient: $recipient, description: $description, date: $date, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, amount, recipient, description, date, status);
...
abstract class _PaymentModel implements PaymentModel {
  const factory _PaymentModel(
      ...
      required final String status}) = _$PaymentModelImpl;
