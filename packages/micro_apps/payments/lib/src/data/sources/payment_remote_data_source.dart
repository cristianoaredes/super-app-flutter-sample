...
class PaymentRemoteDataSourceImpl implements PaymentRemoteDataSource {
  ...
  Future<List<PaymentModel>> getPayments() async {
    ...
    if (response.isSuccess) {
      ...
      throw Exception('Falha ao obter pagamentos: ${response.statusCode}');
    }
  }
  ...
  Future<PaymentModel?> getPaymentById(String id) async {
    ...
    if (response.isSuccess) {
      ...
      throw Exception('Falha ao obter pagamento: ${response.statusCode}');
    }
  }
  ...
  Future<PaymentModel> makePayment(PaymentModel payment) async {
    ...
    if (response.isSuccess) {
      ...
      throw Exception('Falha ao fazer pagamento: ${response.statusCode}');
    }
  }
  ...
  Future<bool> cancelPayment(String id) async {
    ...
    if (response.isSuccess) {
      ...
      throw Exception('Falha ao cancelar pagamento: ${response.statusCode}');
    }
  }
}
